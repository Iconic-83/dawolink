...
const ACTION_OPTIONS = [
  ...
  "BRANCH_CREATED", "BRANCH_UPDATED", "BRANCH_DEACTIVATED", "PHARMACY_UPDATED", "SETTINGS_UPDATED", "BACKUP_RESTORED",
];
...
const ACTION_META: Record<string, { label: string; variant: "success" | "info" | "warning" | "danger" | "default" | "muted" }> = {
  ...
  BACKUP_RESTORED:        { label: "Backup Restored",   variant: "warning" },
